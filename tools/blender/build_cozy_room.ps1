...
try {
  & $blenderPath --background --python "tools\blender\build_cozy_room.py"
  ...
  $required = @(
    ...
    "packages\assets\3d\previews\habitacion-cozy-premium.png",
    "packages\assets\3d\source\cozy-modern-master-v1.report.json"
  )
